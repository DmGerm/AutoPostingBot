...
6. **Авторизация:**
   ...
   * После запуска перейдите в браузере на главную страницу приложения (`/`). Первый пользователь становится администратором
...
8. **Примеры использования:**
   ...
   * **Смена пароля:** для любого зарегистрированного пользователя реализована страница смены пароля (`/ChangePassword`), которая доступна из меню. Достаточно ввести старый и новый пароль, система проверит их корректность (минимум 8 символов, цифры, буквы).
   * **Управление пользователями (Admin):** под учётной записью администратора можно перейти на страницу «Управление пользователями» (`/usersmanager`) и добавлять/редактировать пользователей и их роли. 
